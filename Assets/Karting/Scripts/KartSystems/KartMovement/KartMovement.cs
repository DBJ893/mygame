...
namespace KartGame.KartSystems
{
    ...
    public class KartMovement : MonoBehaviour, IKartCollider, IMovable, IKartInfo
    {
        ...
        void FixedUpdate ()
        {
			...
			//m_Movement = transform.Translat(Input.acceleration.x,0,-Input.acceleration.z);
			//m_RepositionPositionDelta.x = Input.GetAxis("Horizontal");
			...
			//Quaternion rotationStream = transform.Translate(Input.acceleration.x,0,-Input.acceleration.z);
